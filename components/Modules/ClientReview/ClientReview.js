                  ...
                  <Col lg={7} md={7}>
                    <div className="align-items-center sec_height">
                      ...
                      <p className="commentText pe-5 pb-4">
                        ...
                        web application.The project has been being implemented
                        in close cooperation and we have influence on the
                        project progress.
                      </p>
                ...
                <Row>
                  ...
                  <Col lg={7} md={7}>
                    <div className="align-items-center sec_height">
                      ...
                      />
                      <p className="commentText pe-5 pb-4">
                        We have been working with API SOLUTIONS for over a year
                        now and have found them to be terrific Tech Partners. We
                        will happly work with them again.
                      </p>
                      <div className="border-start border-2 border-w-2 border-secondary mt-3 review_person">
                        <p className="client_name text-capitalize ps-3 mb-0">
